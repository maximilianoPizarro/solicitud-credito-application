...
import com.credito.webapp.domain.User;
import com.credito.webapp.service.InvalidPasswordException;
import com.credito.webapp.service.MailService;
import com.credito.webapp.service.UserService;
import com.credito.webapp.service.UsernameAlreadyUsedException;
import com.credito.webapp.service.dto.PasswordChangeDTO;
import com.credito.webapp.service.dto.UserDTO;
import com.credito.webapp.web.rest.errors.EmailAlreadyUsedException;
import com.credito.webapp.web.rest.errors.InvalidPasswordWebException;
import com.credito.webapp.web.rest.errors.LoginAlreadyUsedException;
import com.credito.webapp.web.rest.vm.KeyAndPasswordVM;
import com.credito.webapp.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
    ...
    public CompletionStage<Response> registerAccount(@Valid ManagedUserVM managedUserVM) {
        ...
        } catch (com.credito.webapp.service.EmailAlreadyUsedException e) {
            throw new EmailAlreadyUsedException();
        }
    }
